        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isInternetPresent) {
                    if (a.getText().toString().isEmpty() || b.getText().toString().isEmpty() || c.getText().toString().isEmpty() || d.getText().toString().isEmpty() || e.getText().toString().isEmpty() || f.getText().toString().isEmpty()) {
                        Toast.makeText(getApplicationContext(), "Empty Feild Found!", Toast.LENGTH_SHORT).show();
                    } else {
                        pd.show();
                        intent = new Intent(forgetotp.this, changepsw.class);
